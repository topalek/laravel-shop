<div class="product-card flex flex-col md:flex-row rounded-3xl bg-card">
    <a class="product-card-photo overflow-hidden shrink-0 md:w-[260px] xl:w-[320px] h-[320px] md:h-full rounded-3xl"
       href="{{route('product',$product)}}">
        <img alt="{{$product->title}}" class="object-cover w-full h-full" src="{{ $product->makeThumbnail('345x320') }}">
    </a>
    <div class="grow flex flex-col py-8 px-6 md:px-8">
        ...
        <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mt-6">
            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <a class="w-[56px] !h-[56px] !px-0 btn btn-purple" href="#" title="Удалить из избранного">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
                        <path
