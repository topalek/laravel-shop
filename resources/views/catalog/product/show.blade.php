    ...
    <main class="py-16 lg:py-20">
        <div class="container">
            ...
            <ul class="breadcrumbs flex flex-wrap gap-y-1 gap-x-4 mb-6">
                ...
                <li><a class="text-body hover:text-pink text-xs" href="{{route('shop',$product->categories->first())}}">Мыши</a></li>
            ...
            <section class="mt-12 xl:mt-16 pt-8 lg:pt-12 border-t border-white/10">
                ...
                <article class="text-xs md:text-sm">
                    ...
                    <p class="mb-12">Уникальный перфорированный внешний корпус и уменьшенная электроника - все это с высокой
                        точностью спроектировано так, чтобы обеспечить потрясающе легкий вес и новый уровень прочности.</p>
                </article>
            </section>
