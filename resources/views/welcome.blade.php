    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-8">
                <div
                    ...
                    <svg class="w-10 md:w-12 h-10 md:h-12 opacity-40" fill="currentColor"
        ...
        <section class="mt-16 lg:mt-24">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 md:gap-5 mt-8">
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Мыши</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Клавиатуры</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Наушники</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Поверхности</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Мониторы</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Геймпады</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Консоли</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Акустика</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Аксесуары</a>
                <a class="p-3 sm:p-4 2xl:p-6 rounded-xl bg-card hover:bg-pink text-xxs sm:text-xs lg:text-sm text-white font-semibold"
                   href="catalog.html">Распродажа</a>
            </div>
        </section>
        ...
        <section class="mt-16 lg:mt-24">
            ...
            <div class="mt-12 text-center">
                <a class="btn btn-purple" href="catalog.html">Все товары &nbsp;→</a>
            </div>
        </section>
        ...
        <section class="mt-20">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-6 gap-4 md:gap-8 mt-12">
                <a class="p-6 rounded-xl bg-card hover:bg-card/60" href="catalog.html">
