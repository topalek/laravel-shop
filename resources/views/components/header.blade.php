        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                ...
                <nav class="hidden 2xl:flex gap-8">
                    <a class="text-white hover:text-pink font-bold" href="index.html">Главная</a>
                    <a class="text-white hover:text-pink font-bold" href="catalog.html">Каталог товаров</a>
                    <a class="text-white hover:text-pink font-bold" href="cart.html">Корзина</a>
                </nav>
            </div><!-- /.header-menu -->
            <div class="header-actions flex items-center gap-3 md:gap-5">
                ...
                <a class="flex items-center gap-3 text-pink hover:text-white" href="cart.html">
