...
@section('content')
    <x-forms.auth-form title="Регистрация" action="">
        @csrf
        <x-forms.text-input name="name" type="text" required placeholder="Имя"
        ...
        <x-forms.text-input name="password_confirmation" type="password" required placeholder="Повторно пароль"/>

        <x-forms.primary-btn type="submit">Зарегистрироваться</x-forms.primary-btn>
        ...
        <x-slot:buttons>
            <div class="flex justify-between mt-5">
                ...
                <div class="text-xxs md:text-xs">
                    <a class="text-white hover:text-white/70 font-bold" href="register.html">Регистрация</a>
                </div>
            </div>
